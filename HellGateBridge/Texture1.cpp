...
bool LoadTGA(Texture1 * texture, char * filename)				// Load a TGA file
{
...
bool LoadUncompressedTGA(Texture1 * texture, char * filename, FILE * fTGA)	// Load an uncompressed TGA (note, much of this code is based on NeHe's 
...
bool LoadCompressedTGA(Texture1 * texture, char * filename, FILE * fTGA)		// Load COMPRESSED TGAs
{ 
