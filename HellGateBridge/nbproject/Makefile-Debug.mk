...
${OBJECTDIR}/Pillar.o: Pillar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Pillar.o Pillar.cpp
...
${OBJECTDIR}/TtrashC.o: TtrashC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TtrashC.o TtrashC.cpp
...
${OBJECTDIR}/glm.o: glm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/glm.o glm.cpp
...
${OBJECTDIR}/TrashCPkg.o: TrashCPkg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TrashCPkg.o TrashCPkg.cpp
...
${OBJECTDIR}/glmimg.o: glmimg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/glmimg.o glmimg.cpp

${OBJECTDIR}/BridgeBeamPkg.o: BridgeBeamPkg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BridgeBeamPkg.o BridgeBeamPkg.cpp

${OBJECTDIR}/BigPillar.o: BigPillar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BigPillar.o BigPillar.cpp

${OBJECTDIR}/trashA.o: trashA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/trashA.o trashA.cpp

${OBJECTDIR}/TrashBPkg.o: TrashBPkg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TrashBPkg.o TrashBPkg.cpp
...
${OBJECTDIR}/TrashB.o: TrashB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TrashB.o TrashB.cpp
...
${OBJECTDIR}/RoadPkg.o: RoadPkg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RoadPkg.o RoadPkg.cpp

${OBJECTDIR}/TrashAPkg.o: TrashAPkg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TrashAPkg.o TrashAPkg.cpp

${OBJECTDIR}/bridgeBeam.o: bridgeBeam.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/bridgeBeam.o bridgeBeam.cpp

${OBJECTDIR}/Texture1.o: Texture1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Texture1.o Texture1.cpp
